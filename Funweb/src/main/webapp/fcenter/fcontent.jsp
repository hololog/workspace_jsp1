...
<head>
<meta charset="UTF-8">
<title>fceter/fcontent.jsp</title>
...
<tr><td>첨부파일</td><td colspan="3"><a href="../upload/<%=bDTO.getFile() %>" download><%=bDTO.getFile() %></a></td></tr>
</table>
<div id="table_search">
...
if(id!=null){
	if(id.equals(bDTO.getName())){
		%>
<input type="button" value="글수정" class="btn" onclick="location.href='fupdate.jsp?num=<%=bDTO.getNum() %>'">
<input type="button" value="글삭제" class="btn" onclick="location.href='fdelete.jsp?num=<%=bDTO.getNum() %>'">	
		<%
	}
}
%>
